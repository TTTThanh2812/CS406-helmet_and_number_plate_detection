  ...
  $('#fileInput').on('change', function(event) {
    ...
    if (file && allowedExtensionsForPic.includes(file.name.split('.').pop().toLowerCase())) {
        ...
        reader.onload = function (e) {
            ...
            $('#resultPictureCaption').text('To View Result Click Detect');
        };
      ...
      reader.onload = function (e) {
        $('#inputVideoPic').html(`
          <div class='container d-flex justify-content-center  align-items-center flex-column '>
            <h1 class="font-weight-bold text-center mt-2" id="uploadedVideoCaption">To Detect this Click Detect Button🕵🏼</h1>
            <video id="my-video" class="video-js" controls preload="auto" width="800" height="450" poster="../image/Video_before_detect/Slide2.PNG" data-setup="{}">
    ...
    <div class='container d-flex justify-content-center  align-items-center flex-column '>
    <h1 class="font-weight-bold text-center mt-2" id="uploadedVideoCaption">🎊 Here is the Detect Video 🎊</h1>
        <video id="my-video" class="video-js" controls preload="auto" width="800" height="450" poster="../image/Video_before_detect/Slide2.PNG" data-setup="{}">
